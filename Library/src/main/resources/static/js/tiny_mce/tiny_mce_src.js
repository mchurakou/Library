...
(function(tinymce) {
	tinymce.dom.RangeUtils = function(dom) {
		...
		this.walk = function(rng, callback) {
			...
			// you to fake select table cells and perform formatting com.mikalai.library.actions on them
	...
	tinymce.create('tinymce.ui.Control', {
		...
		setDisabled : function(s) {
			...
			if (s != this.disabled) {
				...
				// Add accessibility title for unavailable com.mikalai.library.actions
